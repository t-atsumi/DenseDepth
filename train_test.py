...
from data_test import get_nyu_train_test_data, get_unreal_train_test_data, get_eyemodel_train_test_data
...
parser.add_argument('--frames', type=int, default=10, help='Num Frames')
...
if args.data == 'eyemodel': 
    train_generator, test_generator = get_eyemodel_train_test_data(batch_size=args.bs, num_frames=args.frames)
